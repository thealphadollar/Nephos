...
## Reporting Bugs
Bugs should be reported in the [issue tracker](https://github.com/thealphadollar/Nephos/issues). Security issues must be reported directly at shivam.cs.iit.kgp+nephos@gmail.com to avoid exploitation.
***
